            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    IdProduto = table.Column<int>(name: "_IdProduto", type: "int", nullable: false)
                        .Annotation("MySQL:ValueGenerationStrategy", MySQLValueGenerationStrategy.IdentityColumn),
                    Descricao = table.Column<string>(name: "_Descricao", type: "longtext", nullable: false),
                    Custo = table.Column<decimal>(name: "_Custo", type: "decimal(18,2)", nullable: false),
                    ...
                    UnidadeMedida = table.Column<string>(name: "_UnidadeMedida", type: "longtext", nullable: false),
